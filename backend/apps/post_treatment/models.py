...
class PostTreatment(models.Model):
  ...
  uploaded_result = CloudinaryField('document', folder='attachments/post_treatment_result/', resource_type='auto', blank=True, null=True)
...
class RequiredAttachment(models.Model):
  ...
  file = CloudinaryField('document', folder='attachments/post_treatment/required_documents', resource_type='auto')
