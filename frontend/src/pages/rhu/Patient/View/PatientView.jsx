...
// --- Reusable UI Helper for Data Display ---
const InfoGroup = ({ label, value, icon: Icon, fullWidth = false }) => (
  <div className={`${fullWidth ? "col-span-full" : ""}`}>
    ...
    <div className="p-2.5 bg-gray-50 border border-gray-200 rounded-md text-sm font-medium text-gray-900 break-words min-h-[42px] flex items-center">
  ...
  if (!patient) return (
    <div className="h-screen flex items-center justify-center bg-gray">
      <div className="text-center">
        ...
        <button onClick={() => navigate("/rhu/patients")} className="text-primary hover:underline mt-2">Go Back</button>
      </div>
    </div>
  );
        ...
        <div className="flex flex-col gap-6 w-full bg-white rounded-lg py-7 px-5 md:px-8 flex-1 overflow-auto shadow-sm">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-gray-100 pb-6 gap-6">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 md:w-20 md:h-20 rounded-full border-2 border-yellow-100 overflow-hidden shrink-0 shadow-sm bg-gray-100">
                <img
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            {/* Left Column: Personal & Socioeconomic */}
            ...
            {/* Right Column: Contact, Emergency & Additional */}
