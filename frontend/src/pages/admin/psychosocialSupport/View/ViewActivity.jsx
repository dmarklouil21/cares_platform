  ...
  const fetchActivity = async () => {
    try {
      ...
      const [activityResponse, attendeesResponse] = await Promise.all([
        // api.get(`/psychosocial-support/cancer-awareness/activity/${id}/`),
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-1">
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  ...
                  <Link
                  // :id/manage-attendees admin/PychosocialSupport/view/3
                    to={`/admin/PychosocialSupport/${id}/manage-attendees`}
