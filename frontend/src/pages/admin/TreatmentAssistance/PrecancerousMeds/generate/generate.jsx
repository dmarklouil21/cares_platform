// src/pages/treatment/AdminPreCancerous/generate/generate.jsx
import React from "react";

export default function PreCancerousPrint({ rows = [] }) {
  const fmtDate = (v) => {
    if (!v) return "";
    try {
      const d = new Date(v);
      ...
      <div className="flex-1 flex flex-col px-26 pt-32">
        <div className="py-5 w-full text-center">
          <h1 className="font-bold text-xl">
            Pre-Cancerous Medication Request List
          </h1>
