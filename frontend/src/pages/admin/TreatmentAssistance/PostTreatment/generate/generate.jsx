// src/pages/treatment/generate/generate.jsx  (PostTreatmentPrint)
import React from "react";

export default function PostTreatmentPrint({ rows = [] }) {
  ...
  return (
    <div
      id="posttreatment-print-content"
    ...
    >
      <style>{`
        ...
        thead { display: table-header-group; } /* ⬅️ repeat header per page */
      ...
      <div className="flex-1 flex flex-col px-24 pt-32">
        <div className="py-5 w-full text-center">
          <h1 className="font-bold text-xl">
            Post Treatment Assistance Requests
          </h1>
