    ...
    >
      ...
      <div className="flex-1 flex flex-col px-26 pt-32">
        <div className="py-5 w-full text-center">
          <h1 className="font-bold text-xl">Mass Screening Requests</h1>
        ...
        <table>
          {/* ⬇️ Updated to 5 columns (no Actions) */}
          <colgroup>
            <col style={{ width: "14%" }} /> {/* Request ID */}
            <col style={{ width: "26%" }} /> {/* RHU name */}
            <col style={{ width: "18%" }} /> {/* Date */}
            <col style={{ width: "20%" }} /> {/* Documents (wider now) */}
            <col style={{ width: "22%" }} /> {/* Status (wider now) */}
          </colgroup>
          <thead>
            <tr>
              <th className="text-left !bg-lightblue">Request ID</th>
              <th className="text-left">RHU name</th>
