...
// Helper for list data (previously checkboxes)
...
const PatientPreScreeningForm = () => {
  ...
  useEffect(() => {
    if (record?.patient) {
      ...
      setForm(record.patient.pre_screening_form || {});
    }
  }, [record]);
        ...
        <div className="flex flex-col gap-6 w-full bg-white rounded-lg py-7 px-5 md:px-8 flex-1 overflow-auto shadow-sm">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-x-12 gap-y-10">
            ...
            <div className="space-y-8">
              ...
              {/* Treatment */}
              <div>
                <SectionHeader icon={Activity} title="Treatment Plan" />
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          ...
          <div className="mt-8 flex items-center justify-between border-t border-gray-100 pt-6">
            <button
              onClick={() => navigate(`/admin/patient/view/${patient?.patient_id}`)}
