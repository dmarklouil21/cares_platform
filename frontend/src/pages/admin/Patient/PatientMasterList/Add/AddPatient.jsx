...
// --- UI Helpers ---
// Added 'disabled' prop handling for InputGroup as well just in case
...
const PatientMasterListAdd = () => {
  ...
  const [form, setForm] = useState({
    ...
    monthly_income: "",
    registered_by: "rafi",
    // Initialize with two empty contacts
    emergency_contacts: [
      { ...DEFAULT_CONTACT },
      { ...DEFAULT_CONTACT },
    ],
  ...
  const handleChange = (e) => {
    ...
    if (name.startsWith("emergencyContact")) {
      ...
      // Clear specific error for contacts
  ...
  const validate = () => {
    ...
    // --- Validation for BOTH Emergency Contacts ---
        ...
        <div className="flex flex-col gap-8 w-full bg-white rounded-lg py-8 px-6 md:px-10 shadow-sm border border-gray-100 flex-1">
            ...
            <div className="flex flex-col md:flex-row gap-6 items-center md:items-start border-b border-gray-100 pb-8">
                ...
                <div className="flex-1 text-center md:text-left">
                    ...
                    <p className="text-xs text-gray-400 mt-2">Please fill in the patient's personal and socioeconomic information to proceed.</p>
                </div>
            </div>
