...
const SelectGroup = ({ label, name, value, options, required = false, error, onChange }) => (
  <div>
    <label className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-1 block">
      {label} {required && <span className="text-red-500">*</span>}
    </label>
...
const PatientMasterListEdit = () => {
  ...
  const handleNext = () => {
    ...
    if (Object.keys(validationErrors).length > 0) {
      ...
      setModalInfo({ type: "error", title: "Validation Error", message: "Please fix the highlighted errors." });
      setShowModal(true);
      return;
    }

    navigate(`/admin/patient/edit/${patient_id}/cancer-data`, {
      state: {
        formData: { ...form },
        photoUrl: imageFile, 
      },
        ...
        <div className="flex flex-col gap-8 w-full bg-white rounded-lg py-8 px-6 md:px-10 shadow-sm border border-gray-100 flex-1">
            ...
            <div className="flex flex-col md:flex-row gap-6 items-center md:items-start border-b border-gray-100 pb-8">
                <div className="relative group cursor-pointer" onClick={() => fileInputRef.current?.click()}>
                    ...
                    {errors.photoUrl && <p className="text-xs text-red-500 text-center mt-1 absolute -bottom-5 left-0 right-0">Required</p>}
                </div>
            ...
            <form className="space-y-8">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <InputGroup label="Barangay" name="barangay" value={form.barangay} onChange={handleChange} required error={errors.barangay} />
                        <InputGroup label="City / Municipality" name="city" value={form.city} onChange={handleChange} required error={errors.city} />
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                        ...
                        <div className="bg-gray-50 p-5 rounded-lg border border-gray-200 space-y-4 relative">
                            ...
                            <InputGroup label="Name" name="emergencyContact2.name" value={form.emergency_contacts[1].name} onChange={handleChange} />
                            <InputGroup label="Relationship" name="emergencyContact2.relationship_to_patient" value={form.emergency_contacts[1].relationship_to_patient} onChange={handleChange} />
                            <div className="grid grid-cols-2 gap-4">
                                <InputGroup label="Mobile" name="emergencyContact2.mobile_number" value={form.emergency_contacts[1].mobile_number} onChange={handleChange} />
                            ...
                            <InputGroup label="Email" name="emergencyContact2.email" value={form.emergency_contacts[1].email} onChange={handleChange} />
                            <InputGroup label="Address" name="emergencyContact2.address" value={form.emergency_contacts[1].address} onChange={handleChange} />
                        </div>
                    </div>
                </div>
