...
const AdminHormonalReplacementAdd = () => {
  ...
  // const [status, setStatus] = useState("Approved"); // Hardcoded in submit
  ...
  const validate = () => {
    ...
    if (date && date < new Date().toISOString().split('T')[0]) {
        newErrors.date = "Cannot be in past";
    }
  ...
  const doSubmit = async () => {
    ...
    try {
      ...
      await api.post(`/survivorship/hormonal-replacement/create/`, formData, {
  ...
  return (
    <div className="w-full h-screen bg-gray flex flex-col overflow-auto">
      ...
      <ConfirmationModal
        ...
        desc="This will create a new hormonal replacement record."
        onConfirm={doSubmit}
        ...
        <div className="flex flex-col gap-8 w-full bg-white rounded-lg py-8 px-6 md:px-10 shadow-sm border border-gray-100 flex-1">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-gray-100 pb-6 gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">Select patient and record medicines requested.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div className="space-y-6">
                    ...
                    <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wide border-l-4 border-purple-500 pl-3 flex items-center gap-2 mt-4">
