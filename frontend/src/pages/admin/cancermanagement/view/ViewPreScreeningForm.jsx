          ...
          >
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-5">
                  <div className="flex flex-col gap-2">
                    <label className="text-gray-700">Final Diagnosis</label>
                    <textarea
              ...
              <div className="flex gap-5 w-full">
                ...
                <div className="flex gap-2 flex-col w-full">
                  <label className="text-gray-700">Date of Assistance</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                      <svg
                        className="w-5 h-5 text-gray-500"
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-wrap gap-x-8 gap-y-3">
                  ...
                  <div className="flex items-center gap-2 w-fit">
                    ...
                    />
                    <label htmlFor="radiotherapy" className="text-gray-700">
                      Radiotherapy
                    </label>
                  </div>
                  <div className="flex items-center gap-2 w-fit">
                    ...
                    />
                    <label htmlFor="chemotherapy" className="text-gray-700">
                      Chemotherapy
                    </label>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-x-8 gap-y-3">
                  <div className="flex items-center gap-2 w-fit">
                    ...
                    />
                    <label htmlFor="immunotherapy" className="text-gray-700">
                      Immunotherapy/Cytrotherapy
                    </label>
                  </div>
                  <div className="flex items-center gap-2 w-fit">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-wrap gap-x-8 gap-y-3">
                  <div className="flex items-center gap-2 w-fit">
                    ...
                    />
                    <label htmlFor="surgeryOther" className="text-gray-700">
                      Surgery
                    </label>
                  </div>
                  <div className="flex items-center gap-2 w-fit">
                ...
                <div className="flex flex-wrap gap-x-8 gap-y-3">
                  ...
                  <div className="flex items-center gap-2 w-fit">
                    ...
                    />
                    <label htmlFor="hormonalOther" className="text-gray-700">
                      Hormonal
                    </label>
                  </div>
                  <div className="flex items-center gap-2 w-fit">
                    ...
                    />
                    <label htmlFor="unknownOther" className="text-gray-700">
                      Unknown
                    </label>
                  </div>
                </div>
