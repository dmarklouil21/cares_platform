  ...
  const stepList = useMemo(() => [
    {
      ...
      description: activeStep === 0 ? (
        ...
        <>Your request has been accepted. You will be notified with your interview date through email.</>
      ),
    },
    {
      ...
      description: activeStep === 1 ? (
        <>
          Your request for radiation therapy has been accepted. Please proceed to the Interview process. 
          You are scheduled for an interview on {new Date(cancerTreatment?.interview_date).toLocaleDateString
            ("en-US", { 
    ...
    },
    {
      ...
      description: activeStep === 2 ? (
        <>
          Your Case Summary and Intervention Plan has been sent to your email. Review, sign and upload it back.
          <Link
      ...
      <div className="h-full w-full p-5 flex flex-col justify-between">
        ...
        <div className="border border-black/15 p-3 bg-white rounded-sm">
          <div className="w-full bg-white rounded-[4px] p-4 ">
            <h2 className="text-md font-bold mb-3">Treatment Application Progress</h2>
