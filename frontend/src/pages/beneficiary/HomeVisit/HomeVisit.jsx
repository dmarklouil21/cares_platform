...
const PatientHomeVisit = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await api.get(`/beneficiary/home-visit/list/`);
  ...
  const handleModalConfirm = async () => {
    if (modalAction?.type === "cancel") {
      try {
        ...
        setLoading(true);
        await api.delete(
          `/beneficiary/home-visit/cancel-request/${modalAction.id}/`
        );
  ...
  const handleView = (id) => {
    navigate(`/beneficiary/home-visit/view/${id}`);
  };
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 w-full">
          ...
          <div className="px-6 py-4 border-b border-gray-200">
            <h3 className="text-lg font-semibold text-yellow-600">
              Track the schedule of your upcoming home visit.
            </h3>
          </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
              ...
              <div className="bg-lightblue px-4 py-3">
                <div className="grid grid-cols-12 gap-4 text-sm font-semibold text-gray-700">
                  ...
                  <div className="col-span-2 text-center">Date Scheduled</div>
                  <div className="col-span-3 text-center">Prepared By</div>
                  <div className="col-span-3 text-center">Approved By</div>
              ...
              <div className="max-h-96 overflow-auto">
                {filteredData.length === 0 ? (
                  <div className="text-center py-8 text-gray-500">
                    No home visit applications found matching your filters.
                  </div>
                ) : (
                    ...
                    {filteredData.map((app) => (
                      ...
                      >
                        ...
                        {/* <div className="col-span-2 flex justify-center gap-2"> */}
                          ...
                          {/* {app.status === "Rejected" && (
                            <button
                              onClick={() => {
                                ...
                                navigate("/beneficiary/services/home-visit/apply", {
                                  state: { id: app.id },
                                });
                              }}
                          ...
                          {/* {app.status !== "Complete" && app.status !== "Scheduled" && (
                            <button
...
export default PatientHomeVisit;