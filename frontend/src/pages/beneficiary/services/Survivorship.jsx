                ...
                {survivorshipOptions.map((option, index) => (
                  ...
                  >
                    <img
                      ...
                      className="h-9 w-9"
                    />
                    <h4 className="text-[16px] md:text-[22px] font-bold text-center text-gray-800">
                      {option.title}
                    </h4>
                    <p className="text-gray2 text-center text-[14px] md:text-[16px]">
                      {option.description}
                    </p>
                    <button className="px-7 py-1 bg-primary text-white text-lg rounded hover:bg-[#5a7c94] transition">
                      Apply
                    </button>
                  </div>
                ))}
