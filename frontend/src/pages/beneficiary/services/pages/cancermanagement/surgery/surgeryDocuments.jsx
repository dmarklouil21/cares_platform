...
const RadioactiveDocument = () => {
  const [activeIdx, setActiveIdx] = useState(0); // start at Endorsement
  ...
  const confirmSubmit = () => {
    ...
    console.log("[Surgery Documents] Submission payload:", payload);
    ...
    <div className="w-full h-screen bg-gray flex flex-col overflow-auto">
      ...
      <div className="py-6 px-5 md:px-10 flex flex-col flex-1 overflow-auto">
        ...
        <div className="rounded-2xl bg-white p-7 flex flex-col gap-3">
          <h2 className="text-3xl text-yellow font-bold">Surgery</h2>
          ...
          <div className="mt-6 flex items-center justify-between flex-col-reverse md:flex-row gap-5">
            <Link
              to="/Beneficiary/services/cancer-management-options/surgery/surgery-well-being-tool"
