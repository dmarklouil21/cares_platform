...
const brachyTherapyWellBeingTool = () => {
  ...
  const handleNext = () => {
    ...
    navigate(
      "/Beneficiary/services/cancer-management-options/brachytherapy/brachy-documents"
    );
  };
      ...
      <div className="py-6 px-10 flex flex-col flex-1 overflow-auto">
        <div className="bg-white rounded-2xl flex p-7 flex-col gap-7">
          ...
          <div className="flex w-full justify-between gap-8">
            <Link
              to="/Beneficiary/services/cancer-management-options/brachytherapy"
...
export default brachyTherapyWellBeingTool;
