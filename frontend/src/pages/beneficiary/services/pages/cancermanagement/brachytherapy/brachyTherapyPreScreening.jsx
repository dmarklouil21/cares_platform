...
const brachyTherapyPreScreening = () => {
  ...
  const handleSubmit = (e) => {
    ...
    navigate(
      "/Beneficiary/services/cancer-management-options/brachytherapy/brachy-well-being-tool"
    );
  };
...
export default brachyTherapyPreScreening;
