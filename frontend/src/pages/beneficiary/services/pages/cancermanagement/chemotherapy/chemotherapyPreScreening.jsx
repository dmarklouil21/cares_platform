...
const chemotherapyPreScreening = () => {
  ...
  const handleSubmit = (e) => {
    ...
    navigate(
      "/Beneficiary/services/cancer-management-options/chemotherapy/chemotherapy-well-being-tool"
    );
  };
...
export default chemotherapyPreScreening;
