          ...
          <div className="p-5 md:p-10 bg-white flex flex-col md:gap-7 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10 p-10 ">
              {supportAgencies.map((agency, index) => (
                ...
                >
                  <div className="p-5 text-center flex flex-col justify-between h-full items-center">
                    ...
                    <Link
                      to={agency.path}
                      className="learn-more-btn bg-primary text-white px-4 py-3 rounded text-sm inline-block md:w-[150px] "
                    >
                      Learn More
                    </Link>
                  </div>
            ...
            <h2 className="text-[18px] md:text-2xl font-bold mb-6">Treatment Center</h2>
            ...
            <div className="bg-white rounded-lg p-6 mb-8 shadow-sm ">
              ...
              <div className="flex items-center gap-2 mb-6">
                ...
                />
                <span className="text-[12px] md:text-[16px]">B. Rodriguez St, Cebu City, 6000 Cebu</span>
              </div>
              ...
              <div className="border-t pt-6">
                ...
                <div className="text-primary mb-3 font-bold text-[12px] md:text-[16px]">VSMMC Cancer</div>
                <p className="mb-2 text-sm text-[12px] md:text-[14px]">Bring the following papers:</p>
