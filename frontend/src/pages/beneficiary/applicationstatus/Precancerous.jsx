                ...
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <thead>
                    <tr className="bg-lightblue">
                      ...
                      <th className="text-center text-[10px] md:text-sm py-3">Last Name</th>
                      <th className="text-center text-[10px] md:text-sm py-3">First Name</th>
                      <th className="text-center text-[10px] md:text-sm py-3">Interpretation</th>
                      <th className="text-center text-[10px] md:text-sm py-3">Status</th>
                      <th className="text-center text-[10px] md:text-sm py-3">Actions</th>
                    </tr>
                  </thead>
                </table>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {filteredData.length === 0 ? (
                        ...
                        filteredData.map((app) => (
                          <tr key={app.id}>
                            <td className="p-2 text-sm text-center text-[#333333]">
                              {app.patientNo}
                            </td>
                            <td className="p-2 text-sm text-center text-[#333333]">
                              {app.lastName}
