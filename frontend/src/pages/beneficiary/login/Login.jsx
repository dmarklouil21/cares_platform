    ...
    try {
      ...
      if (loggedInUser.is_superuser || loggedInUser.is_rhu) {
        setModalInfo({
          ...
          message: "You need a beneficiary account to access this portal.",
        });
        setShowModal(true);
        return;
      }
      ...
      if (loggedInUser.is_first_login) {
        ...
        try {
          ...
          // If 404 or error, assume no profile -> Redirect to Pre-Enrollment
    ...
    <>
      ...
      <div className="w-full h-full min-h-screen bg-gray flex items-center justify-center p-6">
        ...
        <div className="w-full max-w-md bg-white p-8 md:p-10 rounded-lg shadow-xl border border-gray-100">
            ...
            {/* Header Section - Restored Title & Description */}
            <div className="flex flex-col items-center mb-8 text-center gap-2">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                   Welcome back — access your health updates and <br className="hidden md:block"/>
            ...
            <div className="pt-6 border-t border-gray-100 text-center mt-6">
                <p className="text-sm text-gray-600">
                    ...
                    <Link to="/beneficiary-registration" className="font-bold text-primary hover:underline">
                        Register Now
                    </Link>
                </p>
            </div>
