  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.response.data.exists) {
        alert("You already registered as beneficiary");
      }
            ...
            <div className="grid grid-cols-2 gap-x-10 gap-y-5">
              ...
              <div className="flex gap-2 flex-col">
                ...
                <input
                  ...
                  value={formData.emergency_contacts[0].relationship_to_patient}
                  onChange={handleChange}
                  className="border-black border-[1px] rounded-md p-2"
                />
              </div>
            ...
            <div className="grid grid-cols-2 gap-x-10 gap-y-5">
              ...
              <div className="flex gap-2 flex-col">
                ...
                <input
                  ...
                  value={formData.emergency_contacts[1].relationship_to_patient}
                  onChange={handleChange}
                  className="border-black border-[1px] rounded-md p-2"
                />
              </div>
