...
const PreCancerous = () => {
  ...
  const loadList = async () => {
    try {
      setLoading(true);
      setError("");
      const { data } = await api.get("/partners/pre-cancerous/list/");
...
// Stop here for now
  ...
  const handleView = (id) => {
    navigate(`/private/treatment-assistance/pre-cancerous/view/${id}`);
  };
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 min-w-[400px]">
            ...
            <div className="flex gap-3 justify-end">
              <button
                ...
                className="px-4 py-2 bg-gray-300 rounded-md text-sm font-medium transition-colors"
              ...
              <button
                ...
                className="px-4 py-2 bg-primary text-white rounded-md text-sm font-medium transition-colors hover:bg-primary/90"
                        ...
                        <div className="col-span-2 flex justify-center gap-2">
                          ...
                          {p.status === "Verified" && (
                            <button
                              ...
                              className="bg-blue-500 hover:bg-blue-600 text-white py-1.5 px-2 rounded transition-colors"
                              title="Mark as Done"
                            >
