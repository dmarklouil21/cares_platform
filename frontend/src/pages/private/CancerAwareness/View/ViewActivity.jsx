...
const ViewActivity = () => {
  ...
  const fetchActivity = async () => {
    try {
      setLoading(true);
      // Fetching from Private Partner endpoints
    ...
    return (
      <div className="min-h-screen w-full flex flex-col items-center justify-center p-5 bg-gray">
        <div className="text-center">
          ...
          <Link to="/private/cancer-awareness" className="text-primary hover:underline">
            Return to list
          </Link>
        </div>
      </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white rounded-lg border border-gray-200 shadow-sm flex flex-col h-[400px]">
                    ...
                    <div className="p-3 border-t border-gray-200 bg-gray-50">
                       <button
                          onClick={() => navigate(`/private/cancer-awareness/${id}/manage-attendees`)}
