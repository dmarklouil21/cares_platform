...
const ViewPreScreeningForm = () => {
  ...
  // Handle state structure differences if any
  ...
  useEffect(() => {
    if (record) {
      // Prioritize formData if coming from a specific flow, else try direct patient prop
      const patientData = record.formData || record.patient;
      setPatient(patientData);
      setForm(patientData?.pre_screening_form || {});
    }
  }, [record]);
      ...
      <div className="py-5 px-5 md:px-5 flex flex-col flex-1 max-w-7xl mx-auto w-full">
        ...
        <div className="flex flex-col gap-6 w-full bg-white rounded-lg py-7 px-5 md:px-8 flex-1 overflow-auto shadow-sm">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                   ...
                   <div className="grid grid-cols-3 gap-2">
                      <InfoGroup label="T" value={form?.t_system} />
                      <InfoGroup label="N" value={form?.n_system} />
                      <InfoGroup label="M" value={form?.m_system} />
                   </div>
                </div>
          ...
          <div className="mt-8 flex items-center justify-between border-t border-gray-100 pt-6">
            <button
              onClick={() => navigate(`/private/patients/view/${patient.patient_id}`)}
            ...
            <Link
              to={`/private/patients/view/historical-updates`}
