...
import PrivateSidebar from "../navigation/Private";
...
const AdminHeader = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        const d = res.data;
        const name =
          `${d.first_name || ""} ${d.last_name || ""}`.trim() || "Private";
  ...
  return (
    <div className="bg-white py-3.5 px-5 w-full flex justify-between items-center shadow-sm">
      ...
      <h1 className="text-md font-bold">Private Partner</h1>
      ...
      <div className="relative flex items-center gap-3">
        ...
        <div ref={notifRef} className="relative">
          ...
          {showNotifications && (
            <div className="absolute md:right-0 mt-2  -right-30 w-80 bg-white shadow-lg rounded-lg z-50 border border-gray-200">
