...
const AdminSidebar = ({ isSidebarOpen, setIsSidebarOpen }) => {
  ...
  const nav = [
    {
      name: "Dashboard",
      icon: "/assets/images/navigation/admin/dashboard.svg",
      path: "/admin",
      arrow: "",
    },
    {
      name: "Patient",
      icon: "/assets/images/navigation/patient/cancerwarenessicon.svg",
      path: "",
      arrow: "/assets/images/navigation/admin/arrow.svg",
    },
    {
      name: "Cancer Screening",
      icon: "/assets/images/navigation/admin/cancerscreeningicon.svg",
      path: "",
      arrow: "/assets/images/navigation/admin/arrow.svg",
    },
    {
      name: "Treatment Assistance",
      icon: "/assets/images/navigation/admin/treatment.svg",
      path: "",
      arrow: "/assets/images/navigation/admin/arrow.svg",
    },
    {
      name: "Survivorship",
      icon: "/assets/images/navigation/admin/survivorship.svg",
      path: "",
      arrow: "/assets/images/navigation/admin/arrow.svg",
    },
    {
      name: "Cancer Management",
      icon: "/assets/images/navigation/admin/CancerManagement.svg",
      path: "/admin/cancer-management",
      arrow: "",
    },
    {
      name: "Psychosocial Support ",
      icon: "/assets/images/navigation/admin/PychosocialSupport.svg",
      path: "/admin/PychosocialSupport",
      arrow: "",
    },
    {
      name: "User Management",
      icon: "/assets/images/navigation/admin/usermanagementicon.svg",
